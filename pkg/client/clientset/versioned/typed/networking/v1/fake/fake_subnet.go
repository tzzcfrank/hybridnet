...
var subnetsResource = schema.GroupVersionResource{Group: "networking", Version: "v1", Resource: "subnets"}

var subnetsKind = schema.GroupVersionKind{Group: "networking", Version: "v1", Kind: "Subnet"}
...
func (c *FakeSubnets) Get(ctx context.Context, name string, options v1.GetOptions) (result *networkingv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(subnetsResource, name), &networkingv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1.Subnet), err
}
...
func (c *FakeSubnets) List(ctx context.Context, opts v1.ListOptions) (result *networkingv1.SubnetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(subnetsResource, subnetsKind, opts), &networkingv1.SubnetList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &networkingv1.SubnetList{ListMeta: obj.(*networkingv1.SubnetList).ListMeta}
	for _, item := range obj.(*networkingv1.SubnetList).Items {
...
func (c *FakeSubnets) Create(ctx context.Context, subnet *networkingv1.Subnet, opts v1.CreateOptions) (result *networkingv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(subnetsResource, subnet), &networkingv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1.Subnet), err
...
func (c *FakeSubnets) Update(ctx context.Context, subnet *networkingv1.Subnet, opts v1.UpdateOptions) (result *networkingv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(subnetsResource, subnet), &networkingv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1.Subnet), err
...
func (c *FakeSubnets) UpdateStatus(ctx context.Context, subnet *networkingv1.Subnet, opts v1.UpdateOptions) (*networkingv1.Subnet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(subnetsResource, "status", subnet), &networkingv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1.Subnet), err
...
func (c *FakeSubnets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(subnetsResource, name), &networkingv1.Subnet{})
	return err
}
...
func (c *FakeSubnets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &networkingv1.SubnetList{})
	return err
}
...
func (c *FakeSubnets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *networkingv1.Subnet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(subnetsResource, name, pt, data, subresources...), &networkingv1.Subnet{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1.Subnet), err
